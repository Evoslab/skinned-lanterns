...
public class SkinnedLanternBlock extends Block implements IWaterLoggable {
    ...
    public SkinnedLanternBlock(boolean soul) {
        ...
        this.setDefaultState(this.stateContainer.getBaseState().with(HANGING, Boolean.FALSE).with(WATERLOGGED, Boolean.FALSE).with(FACING, Direction.NORTH));
    }
