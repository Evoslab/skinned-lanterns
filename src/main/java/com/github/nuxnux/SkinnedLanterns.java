...
public class SkinnedLanterns implements ModInitializer {
	...
	private static final LanternBlock PUFFERFISH_LANTERN_BLOCK = new LanternBlock(FabricBlockSettings.of(Material.METAL).hardness(3.05f).resistance(3.05f).breakByTool(FabricToolTags.PICKAXES).sounds(BlockSoundGroup.LANTERN).lightLevel(15).breakByHand(false).requiresTool());
	...
	private static final LanternBlock PUFFERFISH_SOUL_LANTERN_BLOCK = new LanternBlock(FabricBlockSettings.of(Material.METAL).hardness(3.05f).resistance(3.05f).breakByTool(FabricToolTags.PICKAXES).sounds(BlockSoundGroup.LANTERN).lightLevel(10).breakByHand(false).requiresTool());
	...
	private static final LanternBlock ZOMBIE_LANTERN_BLOCK = new LanternBlock(FabricBlockSettings.of(Material.METAL).hardness(3.5f).resistance(3.5f).breakByTool(FabricToolTags.PICKAXES).sounds(BlockSoundGroup.LANTERN).lightLevel(15).breakByHand(false).requiresTool());
	...
	private static final LanternBlock ZOMBIE_SOUL_LANTERN_BLOCK = new LanternBlock(FabricBlockSettings.of(Material.METAL).hardness(3.05f).resistance(3.05f).breakByTool(FabricToolTags.PICKAXES).sounds(BlockSoundGroup.LANTERN).lightLevel(10).breakByHand(false).requiresTool());
	...
	private static final LanternBlock CREEPER_LANTERN_BLOCK = new LanternBlock(FabricBlockSettings.of(Material.METAL).hardness(3.05f).resistance(3.05f).breakByTool(FabricToolTags.PICKAXES).sounds(BlockSoundGroup.LANTERN).lightLevel(15).breakByHand(false).requiresTool());
	...
	private static final LanternBlock CREEPER_SOUL_LANTERN_BLOCK = new LanternBlock(FabricBlockSettings.of(Material.METAL).hardness(3.05f).resistance(3.05f).breakByTool(FabricToolTags.PICKAXES).sounds(BlockSoundGroup.LANTERN).lightLevel(10).breakByHand(false).requiresTool());
	...
	private static final LanternBlock SKELETON_LANTERN_BLOCK = new LanternBlock(FabricBlockSettings.of(Material.METAL).hardness(3.05f).resistance(3.05f).breakByTool(FabricToolTags.PICKAXES).sounds(BlockSoundGroup.LANTERN).lightLevel(15).breakByHand(false).requiresTool());
	...
	private static final LanternBlock SKELETON_SOUL_LANTERN_BLOCK = new LanternBlock(FabricBlockSettings.of(Material.METAL).hardness(3.05f).resistance(3.05f).breakByTool(FabricToolTags.PICKAXES).sounds(BlockSoundGroup.LANTERN).lightLevel(10).breakByHand(false).requiresTool());
	...
	private static final LanternBlock WITHER_SKELETON_LANTERN_BLOCK = new LanternBlock(FabricBlockSettings.of(Material.METAL).hardness(3.05f).resistance(3.05f).breakByTool(FabricToolTags.PICKAXES).sounds(BlockSoundGroup.LANTERN).lightLevel(15).breakByHand(false).requiresTool());
	...
	private static final LanternBlock WITHER_SKELETON_SOUL_LANTERN_BLOCK = new LanternBlock(FabricBlockSettings.of(Material.METAL).hardness(3.05f).resistance(3.05f).breakByTool(FabricToolTags.PICKAXES).sounds(BlockSoundGroup.LANTERN).lightLevel(10).breakByHand(false).requiresTool());
	...
	private static final LanternBlock BEE_LANTERN_BLOCK = new LanternBlock(FabricBlockSettings.of(Material.METAL).hardness(3.05f).resistance(3.05f).breakByTool(FabricToolTags.PICKAXES).sounds(BlockSoundGroup.LANTERN).lightLevel(15).breakByHand(false).requiresTool());
	private static final Item BEE_LANTERN_BLOCK_ITEM = new BlockItem(BEE_LANTERN_BLOCK, new Item.Settings().group(MORELANTERNSTAB));
	private static final LanternBlock BEE_SOUL_LANTERN_BLOCK = new LanternBlock(FabricBlockSettings.of(Material.METAL).hardness(3.05f).resistance(3.05f).breakByTool(FabricToolTags.PICKAXES).sounds(BlockSoundGroup.LANTERN).lightLevel(10).breakByHand(false).requiresTool());
	...
	private static final LanternBlock JACK_O_LANTERN_LANTERN_BLOCK = new LanternBlock(FabricBlockSettings.of(Material.METAL).hardness(3.05f).resistance(3.05f).breakByTool(FabricToolTags.PICKAXES).sounds(BlockSoundGroup.LANTERN).lightLevel(15).breakByHand(false).requiresTool());
	...
	private static final LanternBlock JACK_O_LANTERN_SOUL_LANTERN_BLOCK = new LanternBlock(FabricBlockSettings.of(Material.METAL).hardness(3.05f).resistance(3.05f).breakByTool(FabricToolTags.PICKAXES).sounds(BlockSoundGroup.LANTERN).lightLevel(10).breakByHand(false).requiresTool());
	...
	private static final LanternBlock PAPER_WHITE_LANTERN_BLOCK = new LanternBlock(FabricBlockSettings.of(Material.METAL).hardness(3.05f).resistance(3.05f).breakByTool(FabricToolTags.PICKAXES).sounds(BlockSoundGroup.LANTERN).lightLevel(15).breakByHand(false).requiresTool());
	...
	private static final LanternBlock PAPER_WHITE_SOUL_LANTERN_BLOCK = new LanternBlock(FabricBlockSettings.of(Material.METAL).hardness(3.05f).resistance(3.05f).breakByTool(FabricToolTags.PICKAXES).sounds(BlockSoundGroup.LANTERN).lightLevel(10).breakByHand(false).requiresTool());
  ...
  private static final LanternBlock GHOST_LANTERN_BLOCK = new LanternBlock(FabricBlockSettings.of(Material.METAL).hardness(3.05f).resistance(3.05f).breakByTool(FabricToolTags.PICKAXES).sounds(BlockSoundGroup.LANTERN).lightLevel(15).breakByHand(false).requiresTool());
  ...
  private static final LanternBlock GHOST_SOUL_LANTERN_BLOCK = new LanternBlock(FabricBlockSettings.of(Material.METAL).hardness(3.05f).resistance(3.05f).breakByTool(FabricToolTags.PICKAXES).sounds(BlockSoundGroup.LANTERN).lightLevel(10).breakByHand(false).requiresTool());
  ...
  private static final LanternBlock BLINKY_LANTERN_BLOCK = new LanternBlock(FabricBlockSettings.of(Material.METAL).hardness(3.05f).resistance(3.05f).breakByTool(FabricToolTags.PICKAXES).sounds(BlockSoundGroup.LANTERN).lightLevel(15).breakByHand(false).requiresTool());
  ...
  private static final LanternBlock BLINKY_SOUL_LANTERN_BLOCK = new LanternBlock(FabricBlockSettings.of(Material.METAL).hardness(3.05f).resistance(3.05f).breakByTool(FabricToolTags.PICKAXES).sounds(BlockSoundGroup.LANTERN).lightLevel(10).breakByHand(false).requiresTool());
  ...
  private static final LanternBlock PINKY_LANTERN_BLOCK = new LanternBlock(FabricBlockSettings.of(Material.METAL).hardness(3.05f).resistance(3.05f).breakByTool(FabricToolTags.PICKAXES).sounds(BlockSoundGroup.LANTERN).lightLevel(15).breakByHand(false).requiresTool());
  ...
  private static final LanternBlock PINKY_SOUL_LANTERN_BLOCK = new LanternBlock(FabricBlockSettings.of(Material.METAL).hardness(3.05f).resistance(3.05f).breakByTool(FabricToolTags.PICKAXES).sounds(BlockSoundGroup.LANTERN).lightLevel(10).breakByHand(false).requiresTool());
  ...
  private static final LanternBlock INKY_LANTERN_BLOCK = new LanternBlock(FabricBlockSettings.of(Material.METAL).hardness(3.05f).resistance(3.05f).breakByTool(FabricToolTags.PICKAXES).sounds(BlockSoundGroup.LANTERN).lightLevel(15).breakByHand(false).requiresTool());
  ...
  private static final LanternBlock INKY_SOUL_LANTERN_BLOCK = new LanternBlock(FabricBlockSettings.of(Material.METAL).hardness(3.05f).resistance(3.05f).breakByTool(FabricToolTags.PICKAXES).sounds(BlockSoundGroup.LANTERN).lightLevel(10).breakByHand(false).requiresTool());
  private static final Item INKY_SOUL_LANTERN_BLOCK_ITEM = new BlockItem(INKY_SOUL_LANTERN_BLOCK, new Item.Settings().group(MORELANTERNSTAB));
	private static final LanternBlock CLYDE_LANTERN_BLOCK = new LanternBlock(FabricBlockSettings.of(Material.METAL).hardness(3.05f).resistance(3.05f).breakByTool(FabricToolTags.PICKAXES).sounds(BlockSoundGroup.LANTERN).lightLevel(15).breakByHand(false).requiresTool());
	...
	private static final LanternBlock CLYDE_SOUL_LANTERN_BLOCK = new LanternBlock(FabricBlockSettings.of(Material.METAL).hardness(3.05f).resistance(3.05f).breakByTool(FabricToolTags.PICKAXES).sounds(BlockSoundGroup.LANTERN).lightLevel(10).breakByHand(false).requiresTool());
	...
	private static final LanternBlock PACMAN_LANTERN_BLOCK = new LanternBlock(FabricBlockSettings.of(Material.METAL).hardness(3.05f).resistance(3.05f).breakByTool(FabricToolTags.PICKAXES).sounds(BlockSoundGroup.LANTERN).lightLevel(15).breakByHand(false).requiresTool());
	...
	private static final LanternBlock PACMAN_SOUL_LANTERN_BLOCK = new LanternBlock(FabricBlockSettings.of(Material.METAL).hardness(3.05f).resistance(3.05f).breakByTool(FabricToolTags.PICKAXES).sounds(BlockSoundGroup.LANTERN).lightLevel(10).breakByHand(false).requiresTool());
	...
	private static final LanternBlock GUARDIAN_LANTERN_BLOCK = new LanternBlock(FabricBlockSettings.of(Material.METAL).hardness(3.05f).resistance(3.05f).breakByTool(FabricToolTags.PICKAXES).sounds(BlockSoundGroup.LANTERN).lightLevel(15).breakByHand(false).requiresTool());
	...
	private static final LanternBlock GUARDIAN_SOUL_LANTERN_BLOCK = new LanternBlock(FabricBlockSettings.of(Material.METAL).hardness(3.05f).resistance(3.05f).breakByTool(FabricToolTags.PICKAXES).sounds(BlockSoundGroup.LANTERN).lightLevel(10).breakByHand(false).requiresTool());
	...
	private static final LanternBlock PAPER_YELLOW_LANTERN_BLOCK = new LanternBlock(FabricBlockSettings.of(Material.METAL).hardness(3.05f).resistance(3.05f).breakByTool(FabricToolTags.PICKAXES).sounds(BlockSoundGroup.LANTERN).lightLevel(15).breakByHand(false).requiresTool());
	...
	private static final LanternBlock PAPER_YELLOW_SOUL_LANTERN_BLOCK = new LanternBlock(FabricBlockSettings.of(Material.METAL).hardness(3.05f).resistance(3.05f).breakByTool(FabricToolTags.PICKAXES).sounds(BlockSoundGroup.LANTERN).lightLevel(10).breakByHand(false).requiresTool());
	...
	private static final LanternBlock PAPER_ORANGE_LANTERN_BLOCK = new LanternBlock(FabricBlockSettings.of(Material.METAL).hardness(3.05f).resistance(3.05f).breakByTool(FabricToolTags.PICKAXES).sounds(BlockSoundGroup.LANTERN).lightLevel(15).breakByHand(false).requiresTool());
	...
	private static final LanternBlock PAPER_ORANGE_SOUL_LANTERN_BLOCK = new LanternBlock(FabricBlockSettings.of(Material.METAL).hardness(3.05f).resistance(3.05f).breakByTool(FabricToolTags.PICKAXES).sounds(BlockSoundGroup.LANTERN).lightLevel(10).breakByHand(false).requiresTool());
	...
	private static final LanternBlock PAPER_BLUE_LANTERN_BLOCK = new LanternBlock(FabricBlockSettings.of(Material.METAL).hardness(3.05f).resistance(3.05f).breakByTool(FabricToolTags.PICKAXES).sounds(BlockSoundGroup.LANTERN).lightLevel(15).breakByHand(false).requiresTool());
	...
	private static final LanternBlock PAPER_BLUE_SOUL_LANTERN_BLOCK = new LanternBlock(FabricBlockSettings.of(Material.METAL).hardness(3.05f).resistance(3.05f).breakByTool(FabricToolTags.PICKAXES).sounds(BlockSoundGroup.LANTERN).lightLevel(10).breakByHand(false).requiresTool());
	...
	private static final LanternBlock PAPER_LIGHT_BLUE_LANTERN_BLOCK = new LanternBlock(FabricBlockSettings.of(Material.METAL).hardness(3.05f).resistance(3.05f).breakByTool(FabricToolTags.PICKAXES).sounds(BlockSoundGroup.LANTERN).lightLevel(15).breakByHand(false).requiresTool());
	...
	private static final LanternBlock PAPER_LIGHT_BLUE_SOUL_LANTERN_BLOCK = new LanternBlock(FabricBlockSettings.of(Material.METAL).hardness(3.05f).resistance(3.05f).breakByTool(FabricToolTags.PICKAXES).sounds(BlockSoundGroup.LANTERN).lightLevel(10).breakByHand(false).requiresTool());
	...
	private static final LanternBlock PAPER_CYAN_LANTERN_BLOCK = new LanternBlock(FabricBlockSettings.of(Material.METAL).hardness(3.05f).resistance(3.05f).breakByTool(FabricToolTags.PICKAXES).sounds(BlockSoundGroup.LANTERN).lightLevel(15).breakByHand(false).requiresTool());
	...
	private static final LanternBlock PAPER_CYAN_SOUL_LANTERN_BLOCK = new LanternBlock(FabricBlockSettings.of(Material.METAL).hardness(3.05f).resistance(3.05f).breakByTool(FabricToolTags.PICKAXES).sounds(BlockSoundGroup.LANTERN).lightLevel(10).breakByHand(false).requiresTool());
	...
	private static final LanternBlock PAPER_LIME_LANTERN_BLOCK = new LanternBlock(FabricBlockSettings.of(Material.METAL).hardness(3.05f).resistance(3.05f).breakByTool(FabricToolTags.PICKAXES).sounds(BlockSoundGroup.LANTERN).lightLevel(15).breakByHand(false).requiresTool());
	...
	private static final LanternBlock PAPER_LIME_SOUL_LANTERN_BLOCK = new LanternBlock(FabricBlockSettings.of(Material.METAL).hardness(3.05f).resistance(3.05f).breakByTool(FabricToolTags.PICKAXES).sounds(BlockSoundGroup.LANTERN).lightLevel(10).breakByHand(false).requiresTool());
	...
	private static final LanternBlock PAPER_GREEN_LANTERN_BLOCK = new LanternBlock(FabricBlockSettings.of(Material.METAL).hardness(3.05f).resistance(3.05f).breakByTool(FabricToolTags.PICKAXES).sounds(BlockSoundGroup.LANTERN).lightLevel(15).breakByHand(false).requiresTool());
	...
	private static final LanternBlock PAPER_GREEN_SOUL_LANTERN_BLOCK = new LanternBlock(FabricBlockSettings.of(Material.METAL).hardness(3.05f).resistance(3.05f).breakByTool(FabricToolTags.PICKAXES).sounds(BlockSoundGroup.LANTERN).lightLevel(10).breakByHand(false).requiresTool());
	...
	private static final LanternBlock PAPER_LANTERN_BLOCK = new LanternBlock(FabricBlockSettings.of(Material.METAL).hardness(3.05f).resistance(3.05f).breakByTool(FabricToolTags.PICKAXES).sounds(BlockSoundGroup.LANTERN).lightLevel(15).breakByHand(false));
	...
	private static final LanternBlock PAPER_SOUL_LANTERN_BLOCK = new LanternBlock(FabricBlockSettings.of(Material.METAL).hardness(3.05f).resistance(3.05f).breakByTool(FabricToolTags.PICKAXES).sounds(BlockSoundGroup.LANTERN).lightLevel(10).breakByHand(false).requiresTool());
	...
	private static final LanternBlock PAPER_PINK_LANTERN_BLOCK = new LanternBlock(FabricBlockSettings.of(Material.METAL).hardness(3.05f).resistance(3.05f).breakByTool(FabricToolTags.PICKAXES).sounds(BlockSoundGroup.LANTERN).lightLevel(15).breakByHand(false));
	...
	private static final LanternBlock PAPER_PINK_SOUL_LANTERN_BLOCK = new LanternBlock(FabricBlockSettings.of(Material.METAL).hardness(3.05f).resistance(3.05f).breakByTool(FabricToolTags.PICKAXES).sounds(BlockSoundGroup.LANTERN).lightLevel(10).breakByHand(false).requiresTool());
	...
	private static final LanternBlock PAPER_BROWN_LANTERN_BLOCK = new LanternBlock(FabricBlockSettings.of(Material.METAL).hardness(3.05f).resistance(3.05f).breakByTool(FabricToolTags.PICKAXES).sounds(BlockSoundGroup.LANTERN).lightLevel(15).breakByHand(false));
	...
	private static final LanternBlock PAPER_BROWN_SOUL_LANTERN_BLOCK = new LanternBlock(FabricBlockSettings.of(Material.METAL).hardness(3.05f).resistance(3.05f).breakByTool(FabricToolTags.PICKAXES).sounds(BlockSoundGroup.LANTERN).lightLevel(10).breakByHand(false).requiresTool());
	...
	private static final LanternBlock PAPER_BLACK_LANTERN_BLOCK = new LanternBlock(FabricBlockSettings.of(Material.METAL).hardness(3.05f).resistance(3.05f).breakByTool(FabricToolTags.PICKAXES).sounds(BlockSoundGroup.LANTERN).lightLevel(15).breakByHand(false));
	...
	private static final LanternBlock PAPER_BLACK_SOUL_LANTERN_BLOCK = new LanternBlock(FabricBlockSettings.of(Material.METAL).hardness(3.05f).resistance(3.05f).breakByTool(FabricToolTags.PICKAXES).sounds(BlockSoundGroup.LANTERN).lightLevel(10).breakByHand(false).requiresTool());
	...
	private static final LanternBlock PAPER_GRAY_LANTERN_BLOCK = new LanternBlock(FabricBlockSettings.of(Material.METAL).hardness(3.05f).resistance(3.05f).breakByTool(FabricToolTags.PICKAXES).sounds(BlockSoundGroup.LANTERN).lightLevel(15).breakByHand(false));
	...
	private static final LanternBlock PAPER_GRAY_SOUL_LANTERN_BLOCK = new LanternBlock(FabricBlockSettings.of(Material.METAL).hardness(3.05f).resistance(3.05f).breakByTool(FabricToolTags.PICKAXES).sounds(BlockSoundGroup.LANTERN).lightLevel(10).breakByHand(false).requiresTool());
	...
	private static final LanternBlock PAPER_LIGHT_GRAY_LANTERN_BLOCK = new LanternBlock(FabricBlockSettings.of(Material.METAL).hardness(3.05f).resistance(3.05f).breakByTool(FabricToolTags.PICKAXES).sounds(BlockSoundGroup.LANTERN).lightLevel(15).breakByHand(false));
	...
	private static final LanternBlock PAPER_LIGHT_GRAY_SOUL_LANTERN_BLOCK = new LanternBlock(FabricBlockSettings.of(Material.METAL).hardness(3.05f).resistance(3.05f).breakByTool(FabricToolTags.PICKAXES).sounds(BlockSoundGroup.LANTERN).lightLevel(10).breakByHand(false).requiresTool());
	...
	private static final LanternBlock PAPER_MAGENTA_LANTERN_BLOCK = new LanternBlock(FabricBlockSettings.of(Material.METAL).hardness(3.05f).resistance(3.05f).breakByTool(FabricToolTags.PICKAXES).sounds(BlockSoundGroup.LANTERN).lightLevel(15).breakByHand(false));
	...
	private static final LanternBlock PAPER_MAGENTA_SOUL_LANTERN_BLOCK = new LanternBlock(FabricBlockSettings.of(Material.METAL).hardness(3.05f).resistance(3.05f).breakByTool(FabricToolTags.PICKAXES).sounds(BlockSoundGroup.LANTERN).lightLevel(10).breakByHand(false).requiresTool());
	...
	private static final LanternBlock PAPER_PURPLE_LANTERN_BLOCK = new LanternBlock(FabricBlockSettings.of(Material.METAL).hardness(3.05f).resistance(3.05f).breakByTool(FabricToolTags.PICKAXES).sounds(BlockSoundGroup.LANTERN).lightLevel(15).breakByHand(false));
	...
	private static final LanternBlock PAPER_PURPLE_SOUL_LANTERN_BLOCK = new LanternBlock(FabricBlockSettings.of(Material.METAL).hardness(3.05f).resistance(3.05f).breakByTool(FabricToolTags.PICKAXES).sounds(BlockSoundGroup.LANTERN).lightLevel(10).breakByHand(false).requiresTool());
